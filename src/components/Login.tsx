...
export const Login: React.FC = () => {
  const { login, signUp, loginWithGoogle, resetPassword } = useApp();
          ...
          {mode === 'LOGIN' && (
            <form onSubmit={handleLoginSubmit} className="space-y-5">
              ...
              <div className="relative flex items-center justify-center my-3">
                ...
                <span className="bg-white px-3 text-xs text-gray-400 font-medium uppercase absolute">ou</span>
              </div>

              <button
                type="button"
                onClick={() => loginWithGoogle()}
                className="w-full py-3 bg-white hover:bg-gray-50 text-gray-700 font-semibold rounded-xl border border-gray-300 shadow-xs flex items-center justify-center gap-3 transition-all cursor-pointer"
              >
